var card = function(r) {
    ...
    var a, n, o = [].slice;
    n = t(6), (a = t(17)).card = {}, a.card.fn = {}, a.fn.card = function(r) {
        return a.card.fn.construct.apply(this, r)
    }, a.fn.extend({
        card: function() {
            var r, e;
            return e = arguments[0], r = 2 <= arguments.length ? o.call(arguments, 1) : [], this.each((function() {
                var t, o;
                if ((o = (t = a(this)).data("card")) || (a.each(e, (function(r, t) {
                    if (t instanceof jQuery) return e[r] = t[0]
                })), e.form = this, t.data("card", o = new n(e))), "string" == typeof e) return o[e].apply(o, r)
            }))
        }
    })
}, function(r, e, t) {
    (function(e) {
        var a, n, o;
        t(7), n = t(2), t(8), o = t(11), a = function() {
            var r, e;
