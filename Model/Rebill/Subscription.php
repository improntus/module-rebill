...
class Subscription extends Rebill
{
    ...
    {
        try {
            return $this->request('client_subscription', 'DELETE', [$id], ['customerEmail' => $customerEmail], ['headers' => ['x-origin' => 'magento']]);
        } catch (Exception $exception) {
            $this->configHelper->logError($exception->getMessage());
            throw $exception;
        }
    ...
    {
        try {
            return $this->request('update_subscription', 'PUT', [$id], $data, ['headers' => ['x-origin' => 'magento']]);
        } catch (Exception $exception) {
            $this->configHelper->logError($exception->getMessage());
            throw $exception;
        }
